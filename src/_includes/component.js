class Component extends DCLogic {
  ...
  slides() {
    return [
      { img: '/assets/images/endoscopes/DSC03657.jpg', t: 'РуСкейп А-2600', s: 'Первая гибридная видеоэндоскопическая система российского производства' },
      { img: '/assets/images/endoscopes/DSC03696.jpg', t: 'Полный эндоскопический комплекс', s: 'Видеопроцессор, источник света и гибкие эндоскопы серии А20 на одной стойке' },
    ...
    return [
      {
        ...
        img: '/assets/images/endoscopes/DSC03657.jpg',
  ...
  distributors() {
    return [
      ...
      { name: 'Диалог',                    legal: 'ООО «Диалог»',                    city: 'Пермь',        inn: '5904128250', email: 'dialogooo@bk.ru',       site: '',             siteHref: '' },
